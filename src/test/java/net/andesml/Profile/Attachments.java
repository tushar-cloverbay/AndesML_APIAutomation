...
public class Attachments extends Base {
	...
	@Test(dataProvider = "version-data-provider",enabled = true)
	public void Attachments_VerifyResponseParameters(String version) throws Exception {
		extentTest.log(LogStatus.PASS, "Test Description : " + "Verify Response Parameters after calling Attachments api.");
		String URI = Constants.profile_domain+"/profiles/v1/"+profile_id+"/verification-doc";
		String payload = JsonUtils
				.payloadGenerator("Inputs\\" + Constants.ENV + "\\Profile\\Attachments.json");
	...
	@Test(dataProvider = "version-data-provider",enabled = true)
	public void Attachments_without_client_id(String version) throws Exception {
		extentTest.log(LogStatus.PASS, "Test Description : " + "Verify status code and error message after calling Attachments api without client_id header.");
		String URI = Constants.profile_domain+"/profiles/v1/"+profile_id+"/verification-doc";
		String payload = JsonUtils
				.payloadGenerator("Inputs\\" + Constants.ENV + "\\Profile\\Attachments.json");
	...
	@Test(dataProvider = "version-data-provider",enabled = true)
	public void Attachments_without_tenant_id(String version) throws Exception {
		extentTest.log(LogStatus.PASS, "Test Description : " + "Verify status code and error message after calling Attachments api without profile_id header.");
		String URI = Constants.profile_domain+"/profiles/v1/"+profile_id+"/verification-doc";
		String payload = JsonUtils
				.payloadGenerator("Inputs\\" + Constants.ENV + "\\Profile\\Attachments.json");
